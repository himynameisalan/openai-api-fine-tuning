...
# Decide your max response tokens
max_tokens = 100
...
def on_submit():
    ...
    completion = openai.Completion.create(model=model_name, prompt=prompt, max_tokens=max_tokens)
...
window = tk.Tk()
window.title("Fine-tuned GPT Model")
